...
new class extends Component {
    ...
    public function with(): array
    {
        ...
        return [
            'purposes' => $query->orderBy('nama')->paginate($this->paginate)
        ];
    }
    ...
    public function store()
    {
        ...
        try {
            if ($this->editingId) {
                $c = Purpose::findOrFail($this->editingId);
                $c->update([
                    'nama' => $this->name,
                    'alamat' => $this->alamat,
                    'no_telepon' => $this->no_telepon,
                ]);
                $this->dispatch('updateAlertToast', 'Tujuan updated');
            } else {
                Purpose::create([
                    'nama' => $this->name,
                    'alamat' => $this->alamat,
                ...
                $this->dispatch('updateAlertToast', 'Tujuan created');
            }
    ...
    public function delete($id)
    {
        ...
        if ($c) {
            $c->delete();
            $this->dispatch('deleteAlertToast', 'Tujuan deleted');
            $this->resetPage();
        } else {
            $this->dispatch('errorAlertToast', 'Tujuan not found');
        }
    }
    ...
    <div class="row">
            ...
            <div class="card card-round">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">@if($editingId) Ubah Tujuan @else Tambah Tujuan @endif</div>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-12">
            <div class="card card-round">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">Daftar Tujuan</div>
